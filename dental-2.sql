...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 25, 2019 at 02:01 PM
...
--
-- Table structure for table `teeth table`
--

DROP TABLE IF EXISTS `teeth table`;
CREATE TABLE IF NOT EXISTS `teeth table` (
  `toothID` varchar(255) NOT NULL,
  `legend` varchar(255) DEFAULT NULL,
  `patientID` int(11) NOT NULL,
  `med_recordID` int(11) NOT NULL,
  PRIMARY KEY (`toothID`),
  KEY `tt1` (`patientID`),
  KEY `tt2` (`med_recordID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `teeth table`
--

INSERT INTO `teeth table` (`toothID`, `legend`, `patientID`, `med_recordID`) VALUES
('A2', NULL, 1, 1);
...
--
-- Constraints for table `teeth table`
--
ALTER TABLE `teeth table`
  ADD CONSTRAINT `tt1` FOREIGN KEY (`patientID`) REFERENCES `patient` (`patientID`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tt2` FOREIGN KEY (`med_recordID`) REFERENCES `medical record` (`med_recordID`) ON UPDATE CASCADE;
COMMIT;
